export const GUIDE_TOPICS = [
  ...
  {
    slug: "setting-up-secure-ecommerce-subdomain-for-website",
    title: "A Step-by-Step Guide to Setting Up a Secure Subdomain for E-commerce Websites",
    difficulty: "Intermediate",
    category: "Security",
    summary: "Learn how to set up a secure subdomain for your e-commerce website, ensuring the protection of sensitive customer data. This guide covers DNS configuration and SSL certificates for subdomains.",
    keywords: ["secure subdomain setup","ecommerce subdomain configuration","subdomain ssl certificate","dns configuration for subdomains","subdomain security best practices"],
    tags: ["E-commerce","Subdomain Security","SSL"],
    relatedSlugs: [],
  },
  {
    slug: "deploying-static-website-to-free-hosting-with-subdomain",
    title: "Deploying a Static Website to Free Hosting with a Custom Subdomain: A Tutorial",
    difficulty: "Beginner",
    category: "Deployment",
    summary: "This tutorial covers the process of deploying a static website to free hosting services using a custom subdomain, including DNS setup and website configuration. Learn how to get your static website online quickly and securely.",
    keywords: ["free hosting with subdomain","static website deployment","custom subdomain setup","dns configuration for static websites","free website hosting with custom domain"],
    tags: ["Static Websites","Free Hosting","Custom Subdomain"],
    relatedSlugs: [],
  },
  {
  ...
  {
    slug: "custom-subdomain-for-ecommerce-setup",
    title: "A Step-by-Step Guide to Setting Up a Custom Subdomain for E-commerce Websites",
    difficulty: "Intermediate",
    category: "Security",
    summary: "Learn how to set up a custom subdomain for your e-commerce website to improve security and user experience. This guide covers the process of configuring DNS records and setting up a secure subdomain.",
    keywords: ["custom subdomain for e-commerce","setting up a subdomain","ecommerce subdomain configuration","secure subdomain setup","dns records for ecommerce"],
    tags: ["E-commerce","Subdomains","Security"],
    relatedSlugs: [],
  },
  {
    slug: "deploy-static-website-to-free-hosting-with-custom-subdomain-tutorial",
    title: "Deploying a Static Website to Free Hosting with a Custom Subdomain: A Tutorial",
    difficulty: "Beginner",
    category: "Deployment",
    summary: "Follow this step-by-step tutorial to deploy a static website to free hosting with a custom subdomain. Learn how to configure DNS records and set up a secure subdomain for your static website.",
    keywords: ["deploy static website to free hosting","custom subdomain for static website","free hosting with subdomain","static website deployment","dns configuration for static website"],
    tags: ["Static Websites","Free Hosting","Deployment"],
    relatedSlugs: [],
  },
  {
  ...
  {
    slug: "secure-ecommerce-subdomain-setup-tutorial",
    title: "A Step-by-Step Guide to Setting Up a Secure Subdomain for E-commerce Websites",
    difficulty: "Intermediate",
    category: "Security",
    summary: "Learn how to set up a secure subdomain for your e-commerce website, including DNS configuration and SSL certificate installation. This tutorial covers the importance of subdomain security for e-commerce websites.",
    keywords: ["secure subdomain setup","e-commerce subdomain security","subdomain ssl certificate","dns configuration for e-commerce","subdomain security best practices"],
    tags: ["E-commerce","Subdomain Security","SSL Certificate"],
    relatedSlugs: [],
  },
];
...
export const BLOG_TOPICS = [
  ...
  {
    slug: "future-of-web-development-trends-in-free-hosting-and-subdomains",
    title: "The Future of Web Development: Trends and Opportunities in Free Hosting and Subdomains",
    category: "Hosting",
    summary: "Explore the current trends and future opportunities in web development, particularly in the context of free hosting and subdomains. This article discusses how these technologies are shaping the web development landscape.",
    keywords: ["future of web development","free hosting trends","subdomain opportunities","web development landscape","free hosting and subdomains"],
    tags: ["Web Development","Free Hosting","Trends"],
    relatedSlugs: [],
  },
  {
    slug: "importance-of-dns-configuration-for-website-performance",
    title: "The Importance of DNS Configuration for Website Performance and User Experience",
    category: "Performance",
    summary: "Discover how DNS configuration impacts website performance and user experience. This article highlights the key considerations for optimizing DNS settings to improve website speed and overall user experience.",
    keywords: ["dns configuration impact","website performance optimization","dns settings for speed","user experience and dns","optimizing dns for website performance"],
    tags: ["DNS","Performance","User Experience"],
    relatedSlugs: [],
  },
  {
    slug: "benefits-and-best-practices-of-subdomains-for-api-development",
    title: "Benefits and Best Practices of Using Subdomains for API Development and Security",
    category: "Security",
  ...
  {
    slug: "subdomain-benefits-for-api-development-and-security",
    title: "The Benefits of Using a Subdomain for API Development and Security",
    category: "Security",
    summary: "Using a subdomain for API development and security can provide an additional layer of protection and improve the overall user experience. In this blog post, we'll explore the benefits of using a subdomain for API development and security.",
    keywords: ["subdomain for api development","api security with subdomain","benefits of subdomain for api","subdomain for api security","api development with subdomain"],
    tags: ["API Development","Security","Subdomains"],
    relatedSlugs: [],
  },
];
